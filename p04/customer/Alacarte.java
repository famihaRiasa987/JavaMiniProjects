...
/**
 * Represents an Subclass Alacarte that inherits Account .
 * This class allows playing media based on the points remaining in the account.
 * 
 * @author Famiha Riasa
 * @version 0.2
 * @since 1.0
...
public class Alacarte extends Account {
    ...
    /**
     * Plays the media if points are available.
